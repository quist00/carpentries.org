...
Since 2022-12-21, 
 ...
 - [{varnish} 0.2.11 -> 0.2.13](https://carpentries.github.io/varnish/news/index.html#varnish-0213)
   - Table styling has been fixed so that tables are more accessible. They no
     ...
     screen readers. 
     <figure>
       <img src='{{ site.urlimg }}/dovetail-table-before.png' alt='screen capture of a simple table with the first column awkwardly indented, text not differentiated from headings, and no indication of even or odd rows' width="45%"/>
       <img src='{{ site.urlimg }}/dovetail-table-after.png' alt='screen capture of a simple table with expected alignment, bold headings, and zebra striping that is much easier to look at' width="45%"/>
     </figure>
