...
Q2 2023), the whole community should be aware and excited for the changes!
...
2. Because we were working with Research Software Engineers, there was an even
   ...
   to be interesting for installing the Workbench because, while everyone on
...
1. We have indeed lowered the barrier for entry to work on and contribute to our
   ...
   folks, but people who have these setups understand the machinery of their
   computers a lot better and these caveats are [well documented in the setup](https://carpentries.github.io/sandpaper-docs/index.html#linux). 
2. The fact that The R for Ecologists lesson was tested in a workshop recently
   and I did not hear anything about it means that either of these can be true:
...
[^1]: The Workbench is hosted on <https://carpentries.r-universe.dev/> and not
  CRAN because the R-Universe allows for rapid patch fixes and updates, whereas
  CRAN's policies expect updates on a 2-month cycle. 
